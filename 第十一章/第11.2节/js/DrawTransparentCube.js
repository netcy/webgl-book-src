...
var fragmentSource=  ' precision mediump float;\n '
 + 'varying vec4 vColor;\n'
 + ' void main(void){\n'
 + '     gl_FragColor = vec4(vColor.r,vColor.g,vColor.b,0.4);\n' // 设置颜色，透明度设置为0.4
 + '}';
  ...
  var program = utils.buildProgram(gl,vertexSource,fragmentSource); // 创建着色器程序 
     ...
     var uProjectMatrix = utils.getVariableLocation(gl,program,'uProjectMatrix',false);
      ...
      var verticesColors = new Float32Array([
           ...
           // 右面四个顶点
             10,10,10, 1,0,0,//v4 绿色
             10,-10,10, 1,0,0,//v5 绿色
             10,10,-10, 1,0,0,//v6 绿色
             10,-10,-10, 1,0,0,//v7 绿色
           // 上面四个顶点
      ...
      // 把缓冲区分配给attribute变量  
      gl.vertexAttribPointer(aPosition,3,gl.FLOAT,false,floatSize * 6 ,0); 
      gl.vertexAttribPointer(aColor,3,gl.FLOAT,false,floatSize * 6 ,floatSize * 3); 
