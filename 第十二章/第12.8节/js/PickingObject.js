...
function load(){
     ...
     var uClicked = utils.getVariableLocation(gl,program,'uClicked',false);
      ...
      canvas.addEventListener('click',function(event){
            ...
            if(x >= rect.left && x < rect.right && y >= rect.top && y < rect.bottom){
                var xInCanvas = x - rect.left,yInCanvas = y - rect.top;
