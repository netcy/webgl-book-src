...
function load(){
  ...
  var program = utils.buildProgram(gl,vertexSource,fragmentSource); // 创建着色器程序 
     ...
     var uNormalMatrix = utils.getVariableLocation(gl,program,'uNormalMatrix',false);
     ...
     var indices = new Uint8Array([
      ...
      var lightColor = [1.0,1.0,1.0],lightPosition = [0,0,15],ambientLightColor = [0.0,0.0,0.0];
